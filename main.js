document.addEventListener("DOMContentLoaded", () => {
  ...
  if (showBtn && cubeScene && cube) {
    showBtn.addEventListener('click', () => {
      ...
      setTimeout(() => {
        ...
        contents.forEach(block => block.classList.add('show'));
      }, 6000);
    });
  }

  //////////////////////////////////////////
  // Анімація секції "about"
  ...
  const translations = {
    ...
    en: {
      ...
      aboutTitle: "About me",
      aboutText: "Hi! My name is Tanya. I am passionate about web development and design, and I love creating websites that not only work perfectly but also look beautiful and modern. I enjoy experimenting with colors, animations, and page structures to make each project unique.\nI love learning new things — it's important for me to constantly develop and improve my skills. My goal is to combine creativity and technology to create websites that inspire and benefit users.\nI am open to new projects and always put my heart and attention to detail into everything I do.",
